<template>
    <div class="container">
      <div class="row">
        <div class="col-lg-12 wow jdystext jdystextanimation" data-wow-delay="1.2s"><span>入驻机械之家中心仓九大优势</span></div>
      </div>
      <div class="row">
        <div class="qgck_liney"></div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay=".2s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">1</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
        ...
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay=".4s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">2</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
                <h5 class="tszz">服务好</h5>
                <p class="fbtzz">高效工作，轻松管理机配生意</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay=".6s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">3</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay=".8s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">4</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
        ...
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay="1s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">5</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
        ...
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay="1.2s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">6</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay="1.4s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">7</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
        ...
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay="1.6s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">8</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
        ...
        <div class="col-md-4">
          <div class="wow kapp kappanimation" data-wow-delay="1.8s">
            <div class="row">
              <div class="col-md-2" style="box-sizing: border-box;padding-left: 2rem"><h1 class="dss">9</h1></div>
              <div class="col-md-10" style="box-sizing: border-box;padding-left: 3rem">
